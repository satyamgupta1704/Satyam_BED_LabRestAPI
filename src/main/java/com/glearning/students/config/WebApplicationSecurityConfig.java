...
public class WebApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.hasAnyRole("USER", "ADMIN").antMatchers(HttpMethod.POST, "/student/save**").hasRole("ADMIN")
		.antMatchers("/student/showFormForUpdate", "/student/delete").hasRole("ADMIN").anyRequest()
